...
# This is using Replit's AI Integrations service, which provides OpenAI-compatible
...
def ask_question(question: str, context_results: list, chat_history: list = None) -> str:
    context_text = "\n\n".join(
        [
...
Please provide a comprehensive answer based on the conversations above."""
    ...
    # the newest OpenAI model is "gpt-5.2" which was released after knowledge cutoff.
...
def summarize_channel(context_results: list) -> str:
    context_text = "\n\n".join(
